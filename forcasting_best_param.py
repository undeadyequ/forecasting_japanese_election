...
if __name__ == '__main__':
    ...
    # Condition
    #methods = ["lr", "dt", "bg_lr", "bag_dt", "gradient_boost"] # grandient_boost_lr is in other file
    methods = ["lr", "dt", "bag_lr", "bag_dt", "gradient_boost"]  # grandient_boost_lr is in other file

    data_condtion = "N2012"

    # output
    ft_importance_f = "result/feature_import.json"
    pred_f = "result/data_election_pred3.csv"
    acc_f = "result/method_acc_temp.csv"
    ...
    for method in methods:
        ...
        feats_important_dicts, feats_import_array = \
            train_clf(method, args.seed_num, args.title, csv_data, data_condition=(data_condtion)) # "1960-2017-N2012", "1960-2017-N2012-N2009", "1960-2021-N2012"
        end = time.time()
    ...
    pd_data.to_csv("result/method_acc_v1.csv")
    # pred_data and acc_data
    csvdata.to_csv("result/data_election_pred4.csv")
